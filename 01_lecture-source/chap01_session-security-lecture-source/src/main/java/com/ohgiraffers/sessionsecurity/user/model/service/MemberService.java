...
public class MemberService {
    ...
    // SecurityConfig 에 있는 PasswordEncoder 를 필드로 의존성 주입
    @Autowired
    ...
    public int regist(SignupDTO signupDTO) {
        ...
        /* comment.
        *   Service 계층은 본격적으로 DB 에 값을 넣기 위한 데이터를 가공하는 계층이다.
        *   현재 signupDTO 에 userPass 필드는 아직 비밀번호가 암호화되어있지 않다.
        *   따라서 DB 에 insert 하기 전 비밀번호를 암호화 할 것이다. */
